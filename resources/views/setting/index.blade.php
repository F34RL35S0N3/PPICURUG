...
<div class="app-layout">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-nav">
            <li><a href="{{ route('setting.index') }}" class="active"><i class="fas fa-cog" style="width:16px;"></i> Setting</a></li>
            <li>
                <a href="{{ route('logout') }}" class="logout-link"
                   onclick="event.preventDefault(); document.getElementById('logout-form-setting').submit();">
                    <i class="fas fa-sign-out-alt" style="width:16px;"></i> Logout
                </a>
                <form id="logout-form-setting" action="{{ route('logout') }}" method="POST" style="display:none;">@csrf</form>
            </li>
        </ul>
    </div>
